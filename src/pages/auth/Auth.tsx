        ...
        <div className="mx-auto lg:min-width">
            <div className="bg-secondary h-screen">
                <div className="flex items-center justify-around pt-12 ">
                    <div
                        className="flex bg-white sm:basis-11/12 md:basis-10/12 lg:basis-9/12 xl:basis-8/12 rounded-3xl h-[785px] max-w-screen-lg">
                        <div className="lg:w-min basis-1/3 bg-base-100 rounded-tl-3xl rounded-bl-3xl">
                            <img src='../../../public/logo.png' alt="findcare"
                        ...
                        <div className="flex items-center flex-col basis-2/3 pt-24">
                            <ul className="menu menu-vertical lg:menu-horizontal bg-[#FDF1F7] rounded-xl w-[487px] justify-center">
                                <li className="w-1/2">
                                    <Link to="/register"
