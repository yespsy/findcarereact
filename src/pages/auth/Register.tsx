    ...
    return (
        <>
            <div className="flex items-center justify-around pt-12 bg-secondary">
                <div className="flex bg-white sm:basis-11/12 md:basis-10/12 lg:basis-9/12 xl:basis-8/12 rounded-3xl h-[785px] max-w-screen-lg mb-14">
                    ...
                    <div className="flex items-center flex-col basis-2/3 pt-24 px-2">
