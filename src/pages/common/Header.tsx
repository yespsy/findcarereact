            ...
            <div className="flex h-[118px] max-w-full justify-center">
                <div className="flex items-center 2xl:basis-8/12 xl:basis-10/12 lg:basis-full justify-between ">
                    ...
                    <div className=" flex flex-row items-center justify-between">
                        ...
                        <Link to="/" className="head-btn-color text-2xl font-medium pl-2 break-keep">服務內容</Link>
                        <Link to="/" className="head-btn-color text-2xl font-medium pl-2 break-keep">新知科普</Link>
                        <Link to="/" className="head-btn-color text-2xl font-medium pl-2 break-keep">聯繫客服</Link>
                        <Link to="/" className="head-btn-color text-2xl font-medium pl-2 break-keep">繁體中文</Link>
                        <Logout/>
                    </div>
                </div>
            </div>
