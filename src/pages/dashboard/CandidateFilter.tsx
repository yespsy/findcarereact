...
export default function CandidateFilter({update}: CandidateFilterProps) {
    ...
    function selected() {
        return <img alt='' src="../../../public/dashboard/check.png" className="w-8 h-8" />
    }
        ...
        <details className="dropdown" ref={myRef}>
            ...
            <ul className="menu dropdown-content bg-base-100 rounded-box z-[1] w-64 py-0 mt-2 ml-6 px-0 shadow-xl text-22p divide-y divide-[#98A2B3] font-normal">
                <li onClick={(e) => onClick(e, 'all')}>
                    <a><img alt='' src="../../../public/dashboard/user.png" className={itemImgCls} />全部{filterName==='全部'?selected():''}</a>
                </li>
                <li onClick={(e) => onClick(e, 'favor')}>
                    <a><img alt='' src="../../../public/dashboard/favor.png" className={itemImgCls} />收藏{filterName==='收藏'?selected():''}</a>
                </li>
                <li onClick={(e) => onClick(e, 'new')}>
                    <a><div className="float-left absolute ml-[11px] text-white">1</div>
                        <img alt='' src="../../../public/dashboard/circle.png" className={itemImgCls} />新增{filterName==='新增'?selected():''}</a>
                </li>
                <li onClick={(e) => onClick(e, 'interviewed')}>
                    <a><img alt='' src="../../../public/dashboard/interviewed.png" className={itemImgCls} />面過{filterName==='面過'?selected():''}</a>
                </li>
            </ul>
        </details>
    );
